        ...
        void testGetMarkets() throws Exception {
                ...
                mockMvc.perform(get("/crypto/coingecko/api/v1/coins") //
                                ...
                                .andExpect(jsonPath("$.data[1].id")
                                                .value("ethereum")) //
                                .andExpect(jsonPath("$.data[1].symbol")
                                                .value("eth")) //
                                .andExpect(jsonPath("$.data[1].name")
                                                .value("Ethereum")) //
                                .andExpect(jsonPath("$.data[1].image").value(
                                                "https://assets.coingecko.com/coins/images/279/large/ethereum.png?1696501628")) //
                                .andExpect(jsonPath("$.data[1].current_price")
                                                .value(2489.94)) //
                                .andExpect(jsonPath("$.data[1].market_cap")
                                                .value(299318023536L)) //
                                .andExpect(jsonPath("$.data[1].market_cap_rank")
                                                .value(2)) //
                                .andExpect(jsonPath(
                                                "$.data[1].fully_diluted_valuation")
                                                                .value(299318023536L)) //
                                .andExpect(jsonPath("$.data[1].total_volume")
                                                .value(7275066671L)) //
                                .andExpect(jsonPath("$.data[1].high_24h")
                                                .value(2531.49)) //
                                .andExpect(jsonPath("$.data[1].low_24h")
                                                .value(2485.33)) //
                                .andExpect(jsonPath(
                                                "$.data[1].price_change_24h")
                                                                .value(-39.68281791189611)) //
                                .andExpect(jsonPath(
                                                "$.data[1].price_change_percentage_24h")
                                                                .value(-1.56873)) //
                                .andExpect(jsonPath(
                                                "$.data[1].market_cap_change_24h")
                                                                .value(-4226118606L)) //
                                .andExpect(jsonPath(
                                                "$.data[1].market_change_percentage_24h")
                                                                .value(0.0)) //
                                .andExpect(jsonPath(
                                                "$.data[1].circulating_supply24h")
                                                                .value(0.0)) //
                                .andExpect(jsonPath("$.data[1].total_supply")
                                                .value(120169997.442938)) //
                                .andExpect(jsonPath("$.data[1].max_supply")
                                                .value(0)) //
                                .andExpect(jsonPath("$.data[1].ath")
                                                .value(4878.26)) //
                                .andExpect(jsonPath(
                                                "$.data[1].ath_change_percentage")
                                                                .value(-48.94296)) //
                                .andExpect(jsonPath("$.data[1].ath_date").value(
                                                "2021-11-10T14:24:19.604")) //
                                .andExpect(jsonPath("$.data[1].atl")
                                                .value(0.432979)) //
                                .andExpect(jsonPath(
