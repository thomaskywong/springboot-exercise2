...
@SpringBootTest
public class CryptoGeckoServiceImplTest {
...
//   @Test
  void testGetMarkets1() {
    ...
    String urlString = CryptoGeckoUrlBuilder.url(Scheme.HTTPS, domain, basepath,
        endpointMarkets, cur, key);
